function loadDropdown() {
    var languages = [
        ...
        "German",
        "French"
    ]; //fetches the diseases by running the function from the queries.js
    for (const language of languages)$("#dropdown").append($(document.createElement("option")).prop({
...
/*______________________________________________________________________________________________________________________________________________*/ function changeLanguage(language) {
...
//# sourceMappingURL=posters.2c26303d.js.map
