...
function toggleplay(id) {
    ...
    if (video.paused || video.ended) {
        ...
        button.innerHTML = '<svg class="w-5 h-5 pl-0.5 border-themeorange" viewBox="0 0 24 24" fill="#E79B25" stroke="#E79B25" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>';
        video.pause();
    }
}
